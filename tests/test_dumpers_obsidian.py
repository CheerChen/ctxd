...
def _make_confluence_dumper(tmp_path: Path, *, output: str | None, auto: bool):
    ...
    dumper = ConfluenceDumper(
        url="https://example.atlassian.net/wiki/spaces/DBRE/pages/12345/Design",
        output=output,
        fmt="md",
        quiet=True,
        obsidian_mode=True,
...
def test_confluence_obsidian_writes_frontmatter_and_body(tmp_path: Path) -> None:
    ...
    assert "confluence_url: https://example.atlassian.net/wiki/spaces/DBRE/pages/12345/Design\n" in content
